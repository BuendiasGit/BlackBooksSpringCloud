...
public class TBooks {
    ...
    public TBooks(Integer bid, String bName, String bType, String bAuthor, Long bPrice, String bImg, String createPerson, String updatePerson, Date createDate, Date updateDate) {
        this.bid = bid;
        this.bName = bName;
        this.bType = bType;
